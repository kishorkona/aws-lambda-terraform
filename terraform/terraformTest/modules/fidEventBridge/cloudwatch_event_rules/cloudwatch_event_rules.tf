resource "aws_cloudwatch_event_rule" "test_730_to_755" {
...
resource "aws_cloudwatch_event_rule" "test_800_to_1900" {
...
resource "aws_cloudwatch_event_rule" "test_1900_to_1910" {
...
resource "aws_lambda_permission" "intraday_cloudwatch_730_to_755" {
  ...
  source_arn = aws_cloudwatch_event_rule.test_730_to_755.arn
...
resource "aws_lambda_permission" "intraday_cloudwatch_800_to_1900" {
  ...
  function_name = var.function_name
  principal     = "events.amazonaws.com"
  source_arn = aws_cloudwatch_event_rule.test_800_to_1900
...
resource "aws_lambda_permission" "intraday_cloudwatch_800_to_1900" {
  ...
  function_name = var.function_name
  principal     = "events.amazonaws.com"
  source_arn = aws_cloudwatch_event_rule.test_1900_to_1910
...
output "rule_names" {
  value = [aws_cloudwatch_event_rule.test_730_to_755.name,
  aws_cloudwatch_event_rule.test_800_to_1900.name,
  aws_cloudwatch_event_rule.test_1900_to_1910.name]
}